...
void app_main() {
    ...
    gpio_config_t leds = {
        .pin_bit_mask = (
            (1ULL << A) | (1ULL << B) | (1ULL << C) | (1ULL << D) | (1ULL << E) | (1ULL << F) | (1ULL << G) | (1ULL << DIG1) | 
            (1ULL << DIG2) | (1ULL << DIG3) | (1ULL << LED_RED) | (1ULL << LED_GREEN) | (1ULL << Left) | (1ULL << right)
        ),
  ...
  // PWM
    ...
    while(1){
        ...
        if (timer_value >= SAMPLE_PERIOD_US) { 
            ...
            int porcentaje = 100 - ((adc_raw * 100) / 4095); 
